<script>
  import { Drawer, Button, CloseButton, Label, Input, Textarea, P, A, Checkbox, CardPlaceholder } from "flowbite-svelte";
...
<Drawer bind:open={open1} class="flex flex-col h-full">
  <div class="flex-1 overflow-y-auto">
    ...
    <form method="dialog" class="mb-6" onsubmit={editUserDetails}>
      <div class="mb-6">
